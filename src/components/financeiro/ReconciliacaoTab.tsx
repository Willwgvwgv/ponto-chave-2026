...
const autoCategorizationRules = [
  ...
  { keywords: ['SALARIO', 'FOLHA', 'PAGAMENTO FUNC'], categoryName: 'Salários e Encargos' },
  { keywords: ['COMBUSTIVEL', 'AUTO POSTO', 'POSTO'], categoryName: 'Combustível' },
  { keywords: ['ALUGUEL'], categoryName: 'Aluguel do Escritório' },
  { keywords: ['ENERGIA', 'CEMIG', 'ENEL', 'EQUATORIAL'], categoryName: 'Energia Elétrica' },
  { keywords: ['TELEFONE', 'TIM', 'VIVO', 'CLARO', 'OI'], categoryName: 'Telefone e Internet' },
  ...
  { keywords: ['PROLABORE', 'PRÓ-LABORE', 'PRO LABORE'], categoryName: 'Pró-labore Sócios' },
];
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-sm rounded-[32px] shadow-2xl overflow-hidden border border-slate-100 p-8 animate-fadeIn">
            <h3 className="text-md font-black text-slate-900 mb-2 uppercase tracking-tight flex items-center gap-1.5">
              <Plus className="w-5 h-5 text-blue-500" /> Criar Novo Lançamento Bancário
            </h3>
            <p className="text-xs text-slate-400 font-bold mb-6 uppercase tracking-wider">Configure a categoria para registrar e conciliar a transação</p>
